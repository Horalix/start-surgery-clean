  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c71ad8ab-74d4-4b2b-becc-c4f0bda22dad",
      },
      {
        name: "twitter:image",
        content:
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    // Publish plain studying progress to the shared leaderboard.
    void import("../lib/study/study-sync").then((m) => m.initStudySync());
  }, []);
